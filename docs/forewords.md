...
Some are likely only comments and, thus, easy to fix. But some are, so to speak, _unique uniques_ Sullien [<img src="https://i.imgur.com/qdtKSSq.png">](https://github.com/Sullien) introduced to tag units and apply vulnerability or strength mechanics (e. g. `[+25]% Strength <for [Bio] units>`). These will be a harder fix, at least for me.  
